<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?= Env::get('APP_URL') ?>/customer/dashboard" class="btn btn-light">Back to Home</a>
    </div>
                    ...
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text text-muted mb-2">
                                Category: <?= ucfirst(str_replace('_', ' ', $car['category'])) ?>
                            </p>
                            <p class="card-text mb-2">
                                Transmission: <?= ucfirst($car['transmission']) ?> |
                                Seats: <?= htmlspecialchars($car['capacity']) ?>
                            </p>
                            <p class="card-text mb-3">
                                <strong>IDR <?= number_format($car['daily_price'], 0, ',', '.') ?>/day</strong>
                            </p>

                            <div class="mt-auto">
                                <a href="<?= Env::get('APP_URL') ?>/cars/<?= $car['id'] ?>" class="btn btn-primary w-100">
                                    View Details
                                </a>
                            </div>
                        </div>
